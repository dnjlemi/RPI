...
model_en = vosk.Model(r"C:\Users\hp\Downloads\Thesis Prototype\vosk-sr\vosk-model-en-us-0.42-gigaspeech")
...
# Define the target words (modify as needed)
target_words = {
    "fire": ["pyre", "far"],
    "sunog": ["tunog", "so no", "nog", "smoke", "surog", "susog"],
    "huwag": ["wag"],
    "warning": ["warning", "burning", "warn", "learning"],
    "magnanakaw": ["muggle", "nanakaw", "nakaw", "mag nakaw"],
    "stop": ["stop"],
    "tulong": ["too long", "long", "pulong"],
...
class App:
    def __init__(self, root):
        ...
        # Add Exit button
        exit_button = Button(root, text="Exit", command=root.destroy, font=("Helvetica", 14))
...
root = tk.Tk()
root.geometry("320x240")  # Adjust size for 3.5-inch LCD
