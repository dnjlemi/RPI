...
# English model
model_en = Model(r"C:\Users\hp\Downloads\Thesis Prototype\vosk-sr\vosk-model-small-en-us-0.15")
recognizer_en = KaldiRecognizer(model_en, 16000)

# Filipino model
model_ph = Model(r"C:\Users\hp\Downloads\Thesis Prototype\vosk-sr\vosk-model-tl-ph-generic-0.6")
recognizer_ph = KaldiRecognizer(model_ph, 16000)
